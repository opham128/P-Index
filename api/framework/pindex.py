...
# =====================================================================
# ORIGINAL SLOW METHOD (Commented out)
# =====================================================================
...
# =====================================================================
# NEW OPTIMIZED METHOD (Written by AI)
# =====================================================================
def get_journal_year_cell(journal, year, max_pages=2, limit=50):
    rows = []
...
def compute_pindex(papers_df):
    ...
    def fetch_cell(journal, year):
        try:
            return (journal, year), get_journal_year_cell(journal, year, max_pages=2)
        except Exception as e:
